...
$current_day = date('l'); // Returns: Monday, Tuesday, Wednesday, etc.

// Fetch barbers who have a schedule for TODAY
  ...
  <main class="min-h-screen bg-gradient-to-b from-zinc-950 to-black py-12 px-6">
    <div class="container mx-auto max-w-6xl">
      ...
      <div class="text-center mb-12">
        ...
        <p class="text-gray-500 text-sm mt-2">Today is <?= $current_day ?></p>
      </div>
          ...
          <div class="fade-in barber-card bg-gradient-to-br from-gray-900 to-gray-800 border-2 border-gray-700 rounded-2xl p-6 flex items-center gap-6" 
            ...
            <div class="relative flex-shrink-0">
              <?php if (!empty($barber['profile_photo'])): ?>
                <img src="../<?= htmlspecialchars($barber['profile_photo']) ?>" 
                     alt="<?= htmlspecialchars($barber['full_name']) ?>" 
                     class="w-20 h-20 rounded-full bg-gradient-to-br <?= $color['gradient'] ?> border-4 border-gray-700 barber-avatar object-cover">
              <?php else: ?>
                <div class="w-20 h-20 rounded-full bg-gradient-to-br <?= $color['gradient'] ?> flex items-center justify-center text-3xl font-bold border-4 border-gray-700 avatar-placeholder">
            ...
            <div class="flex-1">
              ...
              <p class="text-gray-500 text-xs"><?= htmlspecialchars($barber['experience_years']) ?> years experience</p>
              <?php endif; ?>
            </div>
      ...
      <?php else: ?>
        ...
        <div class="empty-state text-center py-20 max-w-2xl mx-auto">
          ...
          <h3 class="text-2xl font-bold mb-2">No Barbers Available Today</h3>
          <p class="text-gray-400 mb-6">All our barbers are off schedule today (<?= $current_day ?>). Please check back on another day or contact us for availability.</p>
