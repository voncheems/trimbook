  ...
  <aside id="sidebar" class="sidebar fixed left-0 top-0 h-full w-80 bg-gradient-to-b from-gray-900 to-gray-950 border-r border-gray-800 z-50 overflow-y-auto">
    <div class="p-6">
      ...
      <nav class="space-y-2">
        ...
        <a href="../dashboards/client_appointments.php" class="flex items-center space-x-3 px-4 py-3 rounded-xl text-gray-300 hover:bg-gray-800/50 hover:text-white transition">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <?php if (count($recent_appointments) > 0): ?>
          ...
          <?php if (count($appointments) > 3): ?>
            <div class="px-8 py-4 border-t border-gray-800 text-center">
              <a href="/trimbook/dashboards/client_appointments.php" class="text-blue-400 hover:text-blue-300 font-semibold transition">
