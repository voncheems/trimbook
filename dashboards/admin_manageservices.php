...
try {
    ...
    $db_error = "Error fetching services: " . $e->getMessage();
}
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <aside id="sidebar" class="sidebar fixed left-0 top-0 h-full w-80 bg-gradient-to-b from-gray-900 to-gray-950 border-r border-gray-800 z-50 overflow-y-auto">
    <div class="p-6">
      ...
      <nav class="space-y-2">
        ...
        <a href="admin_manage_services.php" class="flex items-center space-x-3 px-4 py-3 rounded-xl bg-gray-800/50 text-white font-medium hover:bg-gray-800 transition">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
